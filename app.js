(function () {
  ...
  const I = {
    en: {
      ...
      participants:"Participants",confirmed:"confirmed",openTasks:"Open tasks",needAttention:"need attention",unassignedItems:"Unassigned items",bringList:"on bring list",rideRequests:"Unassigned travel",transport:"people without a car",nextActivities:"Next activities",nextActivitiesSub:"What happens and who owns it",attention:"Needs attention",attentionSub:"Items still unresolved",
  ...
  I.ru.rideRequests="Поездки не назначены";
  I.ru.transport="людей без машины";
  ...
  function render(){
    ...
    byId("unassignedItems").textContent=state.bring.filter(function(x){return !x.owner;}).length;
